...
//
//   NotesSearch({this.notes, this.databaseHelper});
//
...
//     print('query $query');
//     List<Note> noteList = await databaseHelper.searchNotes('note');
//     //  await databaseHelper.searchNotes(query).then((value) {
//     //   for (int i = 0; i < value.length; i++) {
//     //       filteredNotes.add(value[i]);
//     //   }
//     //   return filteredNotes;
//     // });
//     return noteList;
...
//         for (int i = 0; i < value.length; i++) {
//           filteredNotes.add(value[i]);
//           print('1 $filteredNotes');
//         }
//       });
//       print('1 $notes');
//       // databaseHelper.searchNotes(query).then((value) {
//       //   for (int i = 0; i < value.length; i++) {
//       //     filteredNotes.add(value[i]);
//       //     print('1 $filteredNotes');
//       //   }
